...
class SkuBindDeclareErrorCode{
	...
	const ERR_DECLARE_GOODS_SKU_BANDED_CURR_PRODUCT= 'ERR_DECLARE_GOODS_SKU_BANDED_CURR_PRODUCT';
	...
	static $codeMessageMap = array(
		...
		self::ERR_DECLARE_GOODS_SKU_BANDED_CURR_PRODUCT  => 'SKU已经绑定到当前申报产品',
	);
