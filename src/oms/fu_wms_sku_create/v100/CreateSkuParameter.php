...
class CreateSkuParameter extends OmsParameter
{
	public function __construct($data = [])
	{
		parent::__construct($data, array(
			...
			'weight'               => [self::PARAM_TYPE_NUMBER, self::PARAM_REQUIRED],
			'length'               => [self::PARAM_TYPE_NUMBER, self::PARAM_REQUIRED],
			'width'                => [self::PARAM_TYPE_NUMBER, self::PARAM_REQUIRED],
			'height'               => [self::PARAM_TYPE_NUMBER, self::PARAM_REQUIRED],
			...
			'battery_number'       => [self::PARAM_TYPE_NUMBER, self::PARAM_OPTIONAL],
